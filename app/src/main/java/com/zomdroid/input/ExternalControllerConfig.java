...
public class ExternalControllerConfig {
    ...
    public GLFWBinding buttonDpadUp = GLFWBinding.GAMEPAD_DPAD_UP;
    public GLFWBinding buttonDpadDown = GLFWBinding.GAMEPAD_DPAD_DOWN;
    public GLFWBinding buttonDpadLeft = GLFWBinding.GAMEPAD_DPAD_LEFT;
    public GLFWBinding buttonDpadRight = GLFWBinding.GAMEPAD_DPAD_RIGHT;
    ...
    public void resetToDefaults() {
        ...
        buttonDpadUp = GLFWBinding.GAMEPAD_DPAD_UP;
        buttonDpadDown = GLFWBinding.GAMEPAD_DPAD_DOWN;
        buttonDpadLeft = GLFWBinding.GAMEPAD_DPAD_LEFT;
        buttonDpadRight = GLFWBinding.GAMEPAD_DPAD_RIGHT;
    ...
    public static GLFWBinding[] buttonOptions() {
        return new GLFWBinding[]{
                ...
                GLFWBinding.GAMEPAD_DPAD_UP,
                GLFWBinding.GAMEPAD_DPAD_DOWN,
                GLFWBinding.GAMEPAD_DPAD_LEFT,
                GLFWBinding.GAMEPAD_DPAD_RIGHT,
